//! The `stream_commands` tests that need a live Redis. The ones that need none stay in
//! `stream_commands.rs`.
...
use crate::{
    ...
    commands::{
        ...
        XAddOptions, XAutoClaimOptions, XAutoClaimResult, XCfgSetOptions, XGroupCreateOptions,
        XInfoStreamOptions, XNackMode, XNackOptions, XPendingMessageResult, XPendingOptions,
        XReadGroupOptions, XReadOptions, XSetIdOptions, XTrimOptions,
    },
    resp::Value,
