...
pub struct FtInfoResult {
    ...
    pub inverted_sz_mb: usize,
    pub vector_index_sz_mb: usize,
    pub total_inverted_index_blocks: usize,
    pub offset_vectors_sz_mb: usize,
    pub doc_table_size_mb: usize,
    pub sortable_values_size_mb: usize,
    pub key_table_size_mb: usize,
